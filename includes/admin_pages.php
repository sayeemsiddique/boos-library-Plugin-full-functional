...
function mbt_enqueue_admin_resources() {
	...
	wp_localize_script('mbt-admin-pages', 'mbt_admin_pages_i18n', array(
		...
		'genre' => __('Publisher', 'mybooktable'),
...
function mbt_add_admin_pages() {
	...
	add_submenu_page('mbt_dashboard', __('Publishers', 'mybooktable'), __('Publishers', 'mybooktable'), 'manage_categories', 'edit-tags.php?taxonomy=mbt_publisher&amp;post_type=mbt_book');
	...
	remove_submenu_page("edit.php?post_type=mbt_book", "edit-tags.php?taxonomy=mbt_publisher&amp;post_type=mbt_book");
							...
							<?php if(!mbt_get_setting('installed_examples')) { ?>
								<tr>
									...
									<td>
										...
										<p class="description"><?php _e('These examples will help you learn how to set up Genres, Series, Authors, Publishers and Books of your own.', 'mybooktable'); ?></p>
									</td>
								</tr>
							<?php } ?>
							<tr>
							...
							<div class="welcome-panel-column-container">
								...
								<div class="welcome-panel-column">
									...
									<ul>
										...
										<li><div class="welcome-icon welcome-widgets-menus"><?php _e('Manage', 'mybooktable'); ?> <a href="<?php echo(admin_url('edit-tags.php?taxonomy=mbt_publisher')); ?>" data-mbt-track-event-override="dashboard_manage_publishers_click"><?php _e('Publishers', 'mybooktable'); ?></a></div></li>
