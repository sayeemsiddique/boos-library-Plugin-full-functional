...
function mbt_register_taxonomies()
{
	...
	register_taxonomy('mbt_publisher', 'mbt_book', array(
		'hierarchical' => true,
		'labels' => array(
			'name' => __('Publishers', 'mybooktable'),
			'singular_name' => __('Publisher', 'mybooktable'),
			'all_items' => __('All Publisher', 'mybooktable'),
			'add_new' => __('Add New', 'mybooktable'),
			'add_new_item' => __('Add New Publisher', 'mybooktable'),
			'new_item_name' => __('New Publisher', 'mybooktable'),
			'edit_item' => __('Edit Publisher', 'mybooktable'),
			'view_item' => __('View Publisher', 'mybooktable'),
			'update_item' => __('Update Publisher', 'mybooktable'),
			'search_items' => __('Search Publisher', 'mybooktable'),
			'parent_item' => __('Parent Publisher', 'mybooktable'),
			'parent_item_colon' => __('Parent Publishers:', 'mybooktable'),
		),
		'show_ui' => true,
		'show_admin_column' => true,
		'rewrite' => array('slug' => apply_filters('mbt_publisher_rewrite_name', _x('publisher', 'URL slug', 'mybooktable')))
	));
...
function mbt_override_taxonomy_parent_files() {
	...
	if(($pagenow == "edit-tags.php" or $pagenow == "term.php") and ($_GET['taxonomy'] == "mbt_series" or $_GET['taxonomy'] == "mbt_genre" or $_GET['taxonomy'] == "mbt_author" or $_GET['taxonomy'] == "mbt_publisher" or $_GET['taxonomy'] == "mbt_tag")) {
